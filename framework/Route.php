...
class Route {
     ...
     */
    protected static function _checkMiddleware(Request $request, $middleware_symbols)
    {
     ...
     * @throws \InvalidArgumentException
     */
    protected static function _runDispatch(Request $request, $callback, $middleware_symbols, $params = [])
    {
        ...
        if (is_string($callback)) {
            ...
            // call method
            return Container::run($class, $method, $params);
        }
        // is callback
    ...
    public static function setVariableRouteCacheLimit($number)
    {
